...
exports.generateRSAKeys = void 0;
...
function generateRSAKeys(bitLength) {
    return __awaiter(this, void 0, void 0, function () {
        var p, q, n, phin, e, d, rsaPubKey, rsaPrivKey;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    e = 65537n;
                    _a.label = 1;
                case 1: return [4 /*yield*/, bcu.prime(Math.floor(bitLength / 2) + 1)];
                case 2:
                    p = _a.sent();
                ...
                case 3:
                    ...
                    _a.label = 4;
                case 4:
                    if (q === p || bcu.bitLength(n) !== bitLength || bcu.gcd(e, phin) !== 1n) return [3 /*break*/, 1];
                    _a.label = 5;
                case 5:
                    d = bcu.modInv(e, phin);
                    rsaPubKey = new RsaPubKey_1["default"](e, n);
                    rsaPrivKey = new RsaPrivKey_1["default"](d, n);
